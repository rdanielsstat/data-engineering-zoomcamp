...
This separation keeps secrets local while allowing the pipeline definition to remain version controlled. The `.bruin.yml` is not needed if pipelines are pushed to Bruin Cloud because the connections are created separately there.
