...
def create_source(t_env):
    ...
    source_ddl = f"""
        CREATE TABLE green_trips (
            ...
            'format' = 'json',
            'json.fail-on-missing-field' = 'false',       -- <--- ignore missing fields
...
def log_session_aggregation():
    ...
    # ensure Table API operators use single parallelism
    ...
    try:
        ...
        print("Writing session window results failed:", str(e))
